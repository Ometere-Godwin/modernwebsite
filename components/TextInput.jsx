  ...
  return (
    ...
    focus-within:z-10">
      <input
        ...
        {...props}
        placeholder=" "
        className="peer block w-full border border-neutral-300 bg-transparent px-6 pb-4 
        pt-12 text-base/6 text-neutral-950 ring-4 ring-transparent transition focus:border-neutral-950 focus:outline-none
      ...
      <label
        ...
        text-neutral-500 transition-all duration-200 peer-focus:-translate-y-4 
